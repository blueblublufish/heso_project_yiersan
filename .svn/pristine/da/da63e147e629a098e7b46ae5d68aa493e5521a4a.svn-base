 ...
 *
 */
public class Transaction_001087 extends AbstractInterfaceClass {
	private static final Log logger = LogFactory.getLog(Transaction_001087.class);
	@Override
	public String execute(Node xmlBody, String IPAddress) {
		...
		try{  
			...
			WardrobeServiceReturnObject wsro = new WardrobeService().delMyWardrobe(wardrobeId);
			//处理数据
	...
	public static void main(String[] args) {
		...
		sb.append("<account>2222222</account>");

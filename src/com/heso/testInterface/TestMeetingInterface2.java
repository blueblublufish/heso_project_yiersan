 ...
 * @author Jack.Song 
 */  
public class TestMeetingInterface2 {  
    ...
    public static void main(String[] args) {  
       ...
       String url = " http://api.rcmtm.cn/api/order/details/TEST18030168";  
       // String url = "http://127.0.0.1:8087/heso_project_yiersan/servlet/TransactionServlet";  
        TestMeetingInterface2 tmi = new TestMeetingInterface2();  
       /* String xmlString  = "<?xml version='1.0' encoding='utf-8'?><message><head>" +
        		"<type>001081</type><messageId>1</messageId><agentId>001</agentId><digest>MD5数字签名</digest></head><body><orderId>0000000000000215</orderId><desc>668545</desc><token>0</token><account></account><desc>哈236tfyy</desc></body></message>";*/
...
//              java.net.URI uri = java.net.URI.create(path);  
    ...
    public String post(String url,String xmlFileName){    
        ...
        try{    
            ...
            myPost.setRequestHeader("user","XXB"); 
            myPost.setRequestHeader("pwd","efde2bfec356aa7fcdfcf299d36d5d7d"); 

 ...
 * 
 */
public class Transaction_001110 extends AbstractInterfaceClass {
	private static final Log logger = LogFactory.getLog(Transaction_001110.class);
	...
	public String execute(Node xmlBody, String IPAddress) {
		try {
			...
			String checkId = xmlBody.selectSingleNode("checkdetailId").getText();
			 
			
			CheckCartReturnObject ccro = new CartService().delCheckDetail(checkId);
 			String code = "000000";
	...
	public static void main(String[] args) {
		...
		sb.append("<message>");
		sb.append("<head>");
		sb.append("<type>001110</type>");
		sb.append("<messageId>1</messageId>");
		sb.append("<agentId>001</agentId>");
		sb.append("<digest>MD5数字签名</digest>");
		sb.append("</head>");
		sb.append("<body>"); 
		sb.append("<checkdetailId>1</checkdetailId>");
 		sb.append("<account>miammia</account>");

 ...
 * 
 */
public class Transaction_001130 extends AbstractInterfaceClass {
	private static final Log logger = LogFactory.getLog(Transaction_001130.class);
	...
	public String execute(Node xmlBody, String IPAddress) {
		try {
 			...
 			String yangyi = xmlBody.selectSingleNode("yangyi").getText();
 			String images = xmlBody.selectSingleNode("images").getText();
 			String jiajianma = xmlBody.selectSingleNode("jiajianma").getText();
...
*/ 
			  ...
			  code = new ConsumeOrder().updateOrderDetail(images, jiajianma, yangyi, orderId, productId) ;
	...
	public static void main(String[] args) {
		...
		sb.append("<message>");
		sb.append("<head>");
		sb.append("<type>001924</type>");
		sb.append("<messageId>1</messageId>");
		sb.append("<agentId>001</agentId>");
		sb.append("<digest>MD5数字签名</digest>");
		sb.append("</head>");
		sb.append("<body>"); 
 		sb.append("<openId>oWnGPw42hc5LCKlYPlnzAKbOvMO8</openId>");

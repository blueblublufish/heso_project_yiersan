 ...
 * 
 */
public class Transaction_001126 extends AbstractInterfaceClass {
	private static final Log logger = LogFactory.getLog(Transaction_001126.class);

	@Override
	public String execute(Node xmlBody, String IPAddress) {
		try {
 			String liangti = xmlBody.selectSingleNode("liangti").getText();
...
*/ 
			  ...
			  code = new ConsumeOrder().addChengyiliangti(liangti, orderId, pinlei) ;

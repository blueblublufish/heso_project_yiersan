 ...
 *
 */
public class Transaction_001103 extends AbstractInterfaceClass {
	private static final Log logger = LogFactory.getLog(Transaction_001103.class);
	@Override
	public String execute(Node xmlBody, String IPAddress) {
		...
		//	String wardrobeId = xmlBody.selectSingleNode("wardrobeId").getText();
			...
			MallServiceReturnObject msro = new MallService().getServiceListByDesignerId(designerId);

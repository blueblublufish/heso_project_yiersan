 ...
 *
 */
public class Transaction_001132 extends AbstractInterfaceClass {
	private static final Log logger = LogFactory.getLog(Transaction_001132.class);
	@Override
	public String execute(Node xmlBody, String IPAddress) {
		...
		try{   
 		...
 		//	String wardrobeId = xmlBody.selectSingleNode("wardrobeId").getText();
			...
			ArticleAndvideoREturnObject aavro = new ArticleService().getNotFreeVideo(designerId, account, productId);

 ...
 *
 */
public class Transaction_001157 extends AbstractInterfaceClass {
	private static final Log logger = LogFactory.getLog(Transaction_001157.class);
	@Override
	public String execute(Node arg0, String arg1) {
		// TODO Auto-generated method stub
		try {
			//获取信息
			String orderId = arg0.selectSingleNode("orderId").getText().trim();
			...
			StringBuffer data = new StringBuffer();
				...
				ConsumeOrderReturnObject coro = new ConsumeOrder().refundByQuanyi(account, orderId);
	...
	public static void main(String[] args) {
		...
		sb.append("<account>0000000000001851</account>");
		sb.append("<designerid></designerid>"); 
		sb.append("<orderId>0000000000005031</orderId>");

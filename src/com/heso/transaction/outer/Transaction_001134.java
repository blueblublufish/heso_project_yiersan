 ...
 * 
 */
public class Transaction_001134 extends AbstractInterfaceClass {
	private static final Log logger = LogFactory.getLog(Transaction_001134.class);
...
*/ 
			  ...
			  code = new ConsumeOrder().updateOrder(orderId, fenshu, jianyi);
	...
	public static void main(String[] args) {
		...
		sb.append("<orderId>0000000000004506</orderId>");
